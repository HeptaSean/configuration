...
" normal text
hi Normal       gui=NONE guifg=#9C9C9C guibg=#000000
            \ term=NONE cterm=NONE ctermfg=7 ctermbg=0
...
hi CursorColumn gui=NONE guifg=NONE guibg=#1B1B1B
...
hi Folded       gui=NONE guifg=#00AEAE guibg=#1B1B1B
            \ term=NONE cterm=NONE ctermfg=6 ctermbg=8
" 'foldcolumn'
hi clear FoldColumn
hi link FoldColumn Folded
" '~' and '@' at the end of the window
hi NonText      gui=NONE guifg=#9494D7 guibg=#1B1B1B
            \ term=NONE cterm=NONE ctermfg=4 ctermbg=8
hi NonTextBold  gui=bold guifg=#AEAEFB guibg=#1B1B1B
...
hi TabLineSel   gui=bold guifg=#AEAEFB guibg=#000000
            \ term=bold cterm=bold ctermfg=12 ctermbg=0
...
hi ErrorMsg     gui=reverse,bold guifg=#FF9898 guibg=NONE
            \ term=reverse,bold cterm=reverse,bold ctermfg=9 ctermbg=NONE
" warning messages
hi WarningMsg   gui=reverse guifg=#DD8383 guibg=NONE
            \ term=reverse cterm=reverse ctermfg=1 ctermbg=NONE
" 'showmode' message (e.g., "-- INSERT --")
hi ModeMsg      gui=reverse guifg=#9494D7 guibg=NONE
            \ term=reverse cterm=reverse ctermfg=4 ctermbg=NONE
" |more-prompt|
hi clear MoreMsg
hi link MoreMsg ModeMsg
" |hit-enter| prompt and yes/no questions
hi Question     gui=reverse,bold guifg=#86C686 guibg=NONE
            \ term=reverse,bold cterm=reverse,bold ctermfg=10 ctermbg=NONE
" current match in 'wildmenu' completion
hi WildMenu     gui=reverse,bold guifg=#BBBB6B guibg=NONE
            \ term=reverse,bold cterm=reverse,bold ctermfg=11 ctermbg=NONE
" popup menu: normal item
hi Pmenu        gui=NONE guifg=#9C9C9C guibg=#1B1B1B
            \ term=NONE    cterm=NONE ctermfg=7 ctermbg=8
" popup menu: selected item
hi PmenuSel     gui=reverse guifg=#9494D7 guibg=#000000
            \ term=reverse cterm=reverse ctermfg=4 ctermbg=0
" popup menu: scrollbar
hi PmenuSbar    gui=NONE guifg=#9494D7 guibg=#1B1B1B
            \ term=NONE cterm=NONE ctermfg=4    ctermbg=8
" popup menu: thumb of the scrollbar
hi clear PmenuThumb
hi link PmenuThumb PmenuSbar
" visual mode selection
hi Visual       gui=reverse guifg=#9494D7 guibg=NONE
            \ term=reverse cterm=reverse ctermfg=4 ctermbg=NONE
" visual mode selection when vim is "Not Owning the Selection"
hi clear VisualNOS
hi link VisualNOS Visual
" diff mode: Deleted line |diff.txt|
hi DiffDelete   gui=reverse guifg=#DD8383 guibg=NONE
            \ term=reverse cterm=reverse ctermfg=1 ctermbg=NONE
" diff mode: Added line |diff.txt|
hi DiffAdd      gui=reverse guifg=#71A971 guibg=NONE
            \ term=reverse cterm=reverse ctermfg=2 ctermbg=NONE
" diff mode: Changed text within a changed line |diff.txt|
hi DiffText     gui=reverse guifg=#9E9E59 guibg=NONE
            \ term=reverse cterm=reverse ctermfg=3 ctermbg=NONE
" diff mode: Changed line |diff.txt|
hi clear DiffChange
hi link DiffChange CursorColumn
" last search pattern highlighting (see 'hlsearch')
hi Search       gui=reverse,bold guifg=#BBBB6B guibg=NONE
            \ term=reverse,bold cterm=reverse,bold ctermfg=11 ctermbg=NONE
" 'incsearch' highlighting
hi clear IncSearch
hi link IncSearch Search
" word that is not recognized
hi SpellBad     gui=underline guifg=#DD8383 guibg=NONE guisp=#DD8383
            \ term=underline cterm=underline ctermfg=1 ctermbg=NONE
" word that should start with a capital
hi SpellCap     gui=underline guifg=#9494D7 guibg=NONE guisp=#9494D7
            \ term=underline cterm=underline ctermfg=4 ctermbg=NONE
" word that is recognized as one that is hardly ever used
hi SpellRare    gui=underline guifg=#C087C0 guibg=NONE guisp=#C087C0
            \ term=underline cterm=underline ctermfg=5 ctermbg=NONE
" word that is recognized as one that is used in another region
hi SpellLocal   gui=underline guifg=#00AEAE guibg=NONE guisp=#00AEAE
            \ term=underline cterm=underline ctermfg=6 ctermbg=NONE
" character, if it is a paired bracket, and its match
hi MatchParen   gui=reverse,bold guifg=#AEAEFB guibg=NONE
            \ term=reverse,bold cterm=reverse,bold ctermfg=12 ctermbg=NONE
" meta and special keys listed with ":map"
hi SpecialKey   gui=NONE guifg=#00AEAE guibg=NONE
            \ term=NONE cterm=NONE ctermfg=6 ctermbg=NONE
" titles for output from ":set all", ":autocmd" etc.
hi Title        gui=bold guifg=#AEAEFB guibg=NONE
            \ term=bold cterm=bold ctermfg=12 ctermbg=NONE
" directory names (and other special names in listings)
hi Directory    gui=bold guifg=#AEAEFB guibg=NONE
            \ term=bold cterm=bold ctermfg=12 ctermbg=NONE
" place holder characters substituted for concealed text ('conceallevel')
hi Conceal      gui=NONE guifg=#1B1B1B guibg=NONE
            \ term=NONE cterm=NONE ctermfg=8 ctermbg=NONE
" highlight groups for syntax highlighting, just change foreground colours:
hi Comment      gui=NONE guifg=#9E9E59 guibg=NONE
            \ term=NONE cterm=NONE ctermfg=3 ctermbg=NONE
hi Constant     gui=NONE guifg=#71A971 guibg=NONE
            \ term=NONE cterm=NONE ctermfg=2 ctermbg=NONE
hi clear Special
hi link Special SpecialKey
hi Identifier   gui=NONE guifg=#C087C0 guibg=NONE
            \ term=NONE cterm=NONE ctermfg=5 ctermbg=NONE
hi Statement    gui=NONE guifg=#9494D7 guibg=NONE
            \ term=NONE cterm=NONE ctermfg=4 ctermbg=NONE
hi clear PreProc
hi link PreProc Statement
hi clear Type
hi link Type Statement
hi Error        gui=reverse,bold guifg=#FF9898 guibg=NONE
            \ term=reverse,bold cterm=reverse,bold ctermfg=9 ctermbg=NONE
hi Todo         gui=reverse,bold guifg=#BBBB6B guibg=NONE
            \ term=reverse,bold cterm=reverse,bold ctermfg=11 ctermbg=NONE
